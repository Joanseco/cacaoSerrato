...
const photoSlides = [
    { id: 1, src: '/assets/swiper-photos/1.jpg', alt: 'Cacao de Serrato en Francia' },
    { id: 2, src: '/assets/swiper-photos/2.jpg', alt: 'Cacao de Serrato en Francia' },
    { id: 3, src: '/assets/swiper-photos/3.jpg', alt: 'Cacao de Serrato en Francia' },
    ...
    { id: 7, src: '/assets/swiper-photos/7.jpg', alt: 'Cacao de Serrato en Francia' },
...
const SwiperPhotos = () => {
    return (
        ...
        <div className="max-w-2xl mx-auto mt-10 mb-10 p-8 bg-gray-100 rounded-xl shadow-2xl text-center">
            <h2 className="text-4xl mb-4 text-center text-amber-800">Cacao de Serrato por el mundo</h2>
